...
class AlarmActivity : SimpleActivity() {
    companion object {
        ...
        private const val SCREEN_SUNRISE_DURATION_MS = 30_000L
    }
    ...
    private var screenRampAnimator: ValueAnimator? = null
    ...
    /**
     * Screen part of the sunrise: fade the ring screen from dim to full brightness,
     * on top of the flashlight ramp.
     */
    private fun rampScreenLight() {
        screenRampAnimator =
            ValueAnimator.ofFloat(
                0.05f,
                WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_FULL
            ).apply {
                duration = SCREEN_SUNRISE_DURATION_MS
